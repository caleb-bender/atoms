...
If you haven't already read the [Atoms Data Model Classes]() documentation, please do so since it will make understanding the `IAtomicRepository<TModel>` interface much easier.
## Introduction
